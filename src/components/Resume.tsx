...
const Resume = ({edu,exp}) => {
    return (
        <div className=''>
            <div className=' font-bold text-4xl text-pri px-5 my-5 '>  Resume</div>
            <div className='service-container px-5 gap-5  my-5 grid  sm:grid-cols-2 bg-gray-100 py-10'>



                <div className="education space-y-3">
                    <div className=' capitalize text-2xl py-3 font-medium flex gap-3 items-center'> <GiGraduateCap className='text-4xl text0-sec text-pri' /> Education</div>

                    {
                        edu.map((education)=>{
                            return(
                                <div className='max-w-sm border-b flex flex-col justify-center px-3 border-sec hover:text-sec hover:bg-pri rounded-md h-32 mx-auto bg-sec'>
                ...
                <div className="experience space-y-3">
                    <div className=' capitalize text-2xl py-3 font-medium flex gap-3 items-center'> <IoBagCheckSharp className='text-4xl text-pri' />Experience</div>
                  { 
                    exp.map((experience)=>{
                            return(
                                <div className='max-w-sm border-b flex flex-col justify-center px-3 border-sec hover:text-sec hover:bg-pri rounded-md h-32 mx-auto bg-sec'>
            ...
            <div className='px-5 my-5 '>
                ...
                <div className='skills section px-5'>
                    <div>
                        ...
                        <div className="linne">
                            <div className='w-full h-1 bg-thi'></div>
                            <div className='w-[80%] h-1 bg-pri relative -top-1'></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="linne">
                            <div className='w-full h-1 bg-thi'></div>
                            <div className='w-[75%] h-1 bg-pri relative -top-1'></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="linne">
                            <div className='w-full h-1 bg-thi'></div>
                            <div className='w-[93%] h-1 bg-pri relative -top-1'></div>
                        </div>
                    </div>
